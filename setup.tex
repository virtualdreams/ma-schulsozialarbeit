...
\usepackage[backend=biber,maxbibnames=3,bibencoding=utf8,style=authoryear-icomp,bibstyle=numeric,pagetracker=false,isbn=false,maxbibnames=3,maxcitenames=3,minbibnames=1,urldate=long,autocite=footnote]{biblatex}
