...
\usepackage[backend=biber,maxbibnames=3,bibencoding=utf8,style=authortitle-icomp,bibstyle=numeric,pagetracker=false,isbn=false,maxbibnames=3,maxcitenames=3,minbibnames=1,urldate=long]{biblatex}
