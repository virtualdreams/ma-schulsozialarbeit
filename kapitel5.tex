...
Da bereits unter Punkt \ref{sec:k3_Schulsozialarbeit an berufsbildenden Schulen in Sachsen} die Sachlage zum Thema der Schulsozialarbeit an sächsischen beruflichen Schulen ausführlich erläutert wurde, soll hier nur noch eine Kurzfassung darlegt werden um auf die Bedeutsamkeit des Themas hinzuweisen. (Quellen: siehe Daniela)
