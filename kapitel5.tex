...
\label{sec:TheoretischerHintergrundUmfrage}

\subsubsection{Praktische Umsetzung} 
\label{sec:PraktischeUmsetzungUmfrage}
...
\subsubsection{Theoretischer Hintergrund}
\label{sec:TheoretischerHintergrundInterview}

\subsubsection{Praktische Umsetzung}
\label{sec:PraktischeUmsetzungInterview}
